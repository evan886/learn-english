...
aware [əˈwer] adj.意识到；知道
sour [saʊr] n.酸味；痛苦；讨厌的东西；〈美〉酸味饮料 v.恶化；酸腐；使变酸腐
go sour  告吹 变酸；令人失望；变坏
slurp [slɜrp] v.（喝东西时）发出啧啧的声音；啧啧地响
